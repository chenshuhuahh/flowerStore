        ...
        <div class="logo-nav">
            ...
            <div class="logo-nav-left1 col-lg-4">
                ...
                <div class="input-group search-box">
                    <input type="text" class="form-control" id="searchtext" name="searchtext" placeholder="搜索：花名（如小雏菊）" value="<?php echo ($searchstr); ?>">
...
<div class="container" style="margin-top: 20px;margin-bottom: 100px">
    <div class="row">
    <?php if(is_array($goodsinfo)): foreach($goodsinfo as $key=>$g): ?><div class="col-xs-6 col-md-3">
            <div class="thumbnail">
                <div class="outzoom">
                    <a href="<?php echo U('Home/goods/goodsdetail',array('goods_id'=>$g['goods_id']));?>"><img src="<?php echo ($g['goods_img']); ?>" alt="<?php echo ($g['goods_name']); ?>" class="img-responsive zoom" style="height: 250px"></a>
                </div>
                <div class="caption">
                    <h4><a href="<?php echo U('Home/goods/goodsdetail',array('goods_id'=>$g['goods_id']));?>"><?php echo ($g['goods_name']); ?></a></h4>
        ...
        <!-- <div class="col-xs-6 col-md-3">
            <div class="thumbnail">
                <div class="outzoom">
                    <a href="goodsdetail.html"><img src="/myshop/Public/Home/images/02.jpg" alt="" class="img-responsive zoom" style="height: 250px"></a>
                </div>
                <div class="caption">
                    <h4><a href="goodsdetail.html">Running Shoes</a></h4>
                    <p>Vel illum qui dolorem eum fugiat.</p>
                    <div class="new-collections-grid1-left simpleCart_shelfItem">
                        <p><span class="item_price glyphicon glyphicon-jpy">150</span><a class="item_add" href="shoppingcar.html">添加到购物车 </a></p>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-xs-6 col-md-3">
            <div class="thumbnail">
                <div class="outzoom">
                    <a href="goodsdetail.html"><img src="/myshop/Public/Home/images/09.jpg" alt="" class="img-responsive zoom" style="height: 250px"></a>
                </div>
                <div class="caption">
                    <h4><a href="goodsdetail.html">Running Shoes</a></h4>
                    <p>Vel illum qui dolorem eum fugiat.</p>
