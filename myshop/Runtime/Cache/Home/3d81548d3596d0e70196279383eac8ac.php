        ...
        <div class="login-wrap">
            <div class="login-html">
                ...
                <div class="login-form">
                    ...
                    <form action="<?php echo U('Home/User/userlogin');?>" method="post" name="formlogin">
                        <div class="group">
                        ...
                        <div class="group">
                            ...
                            <input id="psw_in" type="password" class="input" data-type="password">
                        </div>
                        <div class="group">
                    ...
                    <form action="<?php echo U('Home/User/userlogin');?>" method="post" name="formregister">
                        <div class="group">
                            <label for="user_up" class="label">用户名</label>
                            <input id="user_up" name="user_up" type="text" class="input">
                        </div>
                        <div class="group">
                            <label for="psw_up" class="label">输入密码</label>
                            <input id="psw_up" name="psw_up" type="password" class="input" data-type="password">
                        </div>
                        <div class="group">
