...
<body>
    ...
    <nav class="navbar navbar-default navbar-static-top" id="mydd" style="background:rgba(83,227,166,0.7);">
        ...
        <ul class="nav navbar-nav navbar-right" style="margin-right: 25px">
            <li><a href="<?php echo U('Home/index/userMain');?>" style="color:#fff"><span class="glyphicon glyphicon-tree-deciduous"></span>&nbsp;SHShop首页</a></li>
            <li><a href="<?php echo U('Admin/index/adminlogout');?>" style="color:#fff" onclick="javascript:return del();"><span class="glyphicon glyphicon-off"></span>&nbsp;注销</a></li>
        </ul>
